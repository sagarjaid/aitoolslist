...
const Tool = ({ name, coverImg, description, title, price, tag1, tag2, url, icon }) => {
    return (
        <div className='flex flex-col lg:flex-row m-1 rounded-xl'>
            ...
            <div className='flex flex-col gap-4 py-4 lg:p-4 lg:pt-0'>
                ...
                <div className='text-sm underline'>Want your tool listed here? Submit your tool Now!</div>
